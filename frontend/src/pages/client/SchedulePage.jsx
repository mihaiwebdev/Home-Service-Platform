...
const SchedulePage = () => {
  ...
  return (
    <motion.div
      ...
      className="py-20 min-h-100dvh px-2 relative"
    >
      ...
      >
        ...
        <div>
          <h1
            className="font-bold rounded-sm mt-6 mb-4
                    ms-2 "
          >
            Selecteaza data
          </h1>
        ...
        {isLoading ? (
          ...
          <div
            className="mt-10 relative bg-dark h-11
                    pl-4 pr-1 rounded-full short:py-1 w-44 "
          >
            <input
              type="submit"
              id="submit"
              ...
              className="text-start text-white
                        w-full h-full"
              value={"Gaseste ajutor"}
            />

            <label
              htmlFor="submit"
              className="bg-white rounded-full py-1.5 px-2.5 absolute
                        right-1 top-1"
            >
