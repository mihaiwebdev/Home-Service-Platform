...
import { useGetWorkerScheduleQuery, useSetWorkerScheduleMutation } from '../../slices/workers/workersApiSlice'
...
const ProgramPage = () => {
    ...
    const handleSelectDate = (e) => { 
        if (selectedDates.includes(e.target.ariaLabel)) {
            setSelectedDates(state => [...state.filter(date => date !== e.target.ariaLabel)]);
        } else {
